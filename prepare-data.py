...
parser.add_argument("--cat_path", help="Path to training set of cat images", default="../demos/cat-and-dog/dataset/test_set/cats/")
parser.add_argument("--dog_path", help="Path to training set of dog images", default="../demos/cat-and-dog/dataset/test_set/dogs/")
